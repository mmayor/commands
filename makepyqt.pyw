...
import re
from PyQt5.QtCore import QObject, pyqtSignal, pyqtSlot, QSettings, QDir, QFile, QT_VERSION_STR, PYQT_VERSION_STR, \
    QProcess, Qt
...
class OptionsForm(QDialog):
    ...
    def __init__(self, parent=None):
        ...
        self.pyuic4Button.clicked.connect(lambda: self.setPath("pyuic4"))
        self.pyrcc4Button.clicked.connect(lambda: self.setPath("pyrcc4"))
        self.pylupdate4Button.clicked.connect(lambda: self.setPath("pylupdate4"))
        self.lreleaseButton.clicked.connect(lambda: self.setPath("lrelease"))
